...
local themeStyles = {
    ...
    Ocean = {
        SchemeColor = Color3.fromRGB(128, 0, 255),   -- main purple
        Background = Color3.fromRGB(35, 0, 60),     -- dark purple background
        Header = Color3.fromRGB(70, 0, 120),        -- slightly lighter purple for headers
        TextColor = Color3.fromRGB(230, 230, 255),  -- light text for readability
        ElementColor = Color3.fromRGB(70, 0, 120)   
    },
    Midnight = {
